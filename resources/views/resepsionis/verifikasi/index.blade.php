                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <div class="h-9 w-9 bg-indigo-100 text-indigo-700 rounded-full flex items-center justify-center font-bold">
                    ...
                    <td class="px-6 py-4 text-center">
                        @if($idnt->status_approval == 'menunggu')
                            <span class="px-3 py-1 text-[11px] font-bold bg-amber-100 text-amber-700 rounded-md uppercase">Pending</span>
                        @elseif($idnt->status_approval == 'disetujui')
                            <span class="px-3 py-1 text-[11px] font-bold bg-emerald-100 text-emerald-700 rounded-md uppercase">Approved</span>
                        @else
                            <span class="px-3 py-1 text-[11px] font-bold bg-rose-100 text-rose-700 rounded-md uppercase">Rejected</span>
                        @endif
                    </td>
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('resepsionis.verifikasi.show', $idnt->id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                ...
                <tr>
                    <td colspan="4" class="px-6 py-12 text-center text-gray-400">
                        <div class="flex flex-col items-center">
                            <svg class="w-12 h-12 mb-3 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
