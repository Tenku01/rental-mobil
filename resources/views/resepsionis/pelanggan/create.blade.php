...
<div class="container mx-auto p-6 mt-10">
    <h1 class="text-3xl font-semibold text-gray-800 mb-6">Tambah Pelanggan</h1>

    <form action="{{ route('resepsionis.pelanggan.store') }}" method="POST" class="bg-white shadow-lg rounded-lg p-8">
        @csrf
